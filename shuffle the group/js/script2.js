...
function AggiungiGruppo(e) {
    ...
    tbodyElement.innerHTML += `
        <tr>
            ...
            <td>
            <button class="deleteBtn"><img class="deleteBtn" src="img/trash.png" alt="elimina" width="15px" height="20px"></button>
            <button class="editBtn"><img src="img/pencil.png" class="editBtn" alt="modifica" width="20px" height="20px"></button>
            </td>
